...
const TopicsEditPage = ({ topic }) => {
  ...
  return (
    ...
    <div className="" >
      {step === 1 && (
        <div className="p-6 text-black w-full flex-items pt-14 overflow-y-auto">
          <form onSubmit={handleUpdateToServer} className='flex flex-col p-5 w-[60%] relative'>
            <label htmlFor="name">
            ...
            <div className='flex flex-col my-8'>
              <div className="flex gap-2">
                ...
                <div className=" relative group flex items-center z-0">
                  ...
                  {/* Tooltip Box */}
                  <div className="absolute z-10 left-28.5 -translate-x-1/2 bottom-[100%] w-64 p-2 rounded bg-green-100 border border-green-500 text-[12px] text-black opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-opacity duration-300">
              ...
              {instructions.map((step, index) => (
                <div key={index} className="flex flex-col my-2 relative">
                  <div className="flex items-center gap-2">
            ...
            <div className="fixed w-[96%] h-15 bg-gray-200 bottom-0 left-[77px] flex justify-center items-center gap-5 px-6 border-t-2 border-gray-300">
              <div className="w-[60%] flex items-center justify-end gap-5 px-5">
                <button 
                type="button"
