...
const Analytics = () => {
    ...
    useEffect(() => {
        ...
        const updated = allDates.map((date) => {
          ...
          // const relatedData = analyticsData[index];
    
          // const dataDate = parse(relatedData.date, 'dd MMM yyyy', new Date());
          // const inRange = dataDate >= startDate && dataDate <= endDate;
      ...
      // const filterAfterFirstNonZero = (items) => {
      //   let hasStarted = false;
      //   return items.filter(item => {
      //       if( !hasStarted && item.count > 0 ){
      //           hasStarted = true;
      //       }
      //       return hasStarted;
      //   })
      ...
      // const removeTrailingZeros = (items) => {
      //   let lastNonZeroIndex = items.length - 1;
      
      //   // Find the last item where count > 0
      //   while (lastNonZeroIndex >= 0 && items[lastNonZeroIndex].count === 0) {
      //     lastNonZeroIndex--;
      //   }
      
      //   // Return everything up to that index
      //   return items.slice(0, lastNonZeroIndex + 1);
      // };
      

      // const startZeroFiltered = filterAfterFirstNonZero(formattedAnalyticsData);
      // const cleanedItems = removeTrailingZeros(startZeroFiltered);
    
      // console.log('Cleaned data', cleanedItems)
